...
class EncryptionService {
  ...
  Future<EncryptedMessage> encryptMessage(
    ...
    // В GCM mode тег аутентификации включён в encrypted.bytes
    return EncryptedMessage(
      encryptedData: encrypted.base64,
      iv: base64Encode(iv),
      salt: base64Encode(salt),
      authTag: '', // Тег включён в encryptedData для GCM
    );
  }
  ...
  Future<String> decryptMessage(
    ...
    try {
      ...
      // В GCM mode тег аутентификации включён в encrypted data
